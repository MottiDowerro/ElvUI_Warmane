...
L["Uncompleted Color"] = "Незавершенное задание"
L["Completed Color"] = "Завершенное задание"
L["Color Transition"] = "Переход цветов"
L["Custom Colors"] = "Кастомные цвета"
L["Colorize Quests"] = "Цветные задания"
L["Display quest levels at Quest Log."] = "Показывать уровни в журнале заданий."
L["Color quests by difficulty and progress in the Quest Tracker."] = "Цвет заданий будет зависеть от сложности и прогресса"
L["Smoothly transition colors from uncompleted to completed as progress increases."] = "Плавно изменяет цвет от незавершенного к завершенному по мере выполнения задания."
L["Enable custom colors for completed and uncompleted quests."] = "Свои цвета для отслеживания прогресса заданий."
L["Mouse Over"] = "При наведении"
L["Abbreviate Enchants"] = "Сокращение зачарований"