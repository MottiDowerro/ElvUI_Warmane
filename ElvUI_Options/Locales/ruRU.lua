...
L["Blizzard Font Size"] = "Размер шрифтов Blizzard"
...
L["Durability Scale"] = "Масштаб прочности"
...
L["Font Size as defined by Blizzard."] = "Размер шрифтов, установленный Blizzard."
L["Font"] = "Шрифт"
L["Fonts"] = "Шрифты"
...
L["Nameplate Scaling"] = "Масштабирование индикаторов имён"
...
L["Say"] = "Сказать"
L["Scale"] = "Масштаб"
L["Scale Nameplates to UI Scale."] = "Масштабировать индикаторы имён под масштаб интерфейса."
...
L["Totems"] = "Тотемы"
L["Server Language Fix"] = "Фикс языка сервера"
L["Check this if your client language and server language are different. This will help with nameplate totem recognition."] = "Включите это, если язык вашего клиента и язык сервера отличаются. Это поможет с распознаванием тотемов на индикаторах здоровья."
...
L["No Font Scale"] = "Без масштабирования шрифта"
L["Dont scale by Font Size as base."] = "Не используйте размер шрифта в качестве основы."
...
L["Custom Class Colors"] = "Свой цвет для классов"
L["Show Enchants"] = "Отображать чары"
L["Show Gems"] = "Отображать гемы"
L["Show ItemLevel"] = "Показывать уровень предметов"
...
L["Reverse Cooldown"] = "Обратный текст восстановления"
L["Raid Icon"] = "Иконка рейда"
L["Icon Frame"] = "Иконка фрейма"
L["Clear"] = "Очистить"
L["Target Scale"] = "Масштаб цели"
L["Scale of the nameplate that is targetted."] = "Масштаб индикатора здоровья выбранной цели."
L["Arrow Size"] = "Размер стрелки"
L["Arrow X-Offset"] = "Отступ стрелки по X"
L["Arrow Y-Offset"] = "Отступ стрелки по Y"
L["Always Show Target Health"] = "Всегда отображать здоровье цели"
L["Use Target Scale"] = "Использовать масштабирование цели"
L["Icon Position"] = "Позиция иконки"
L["Abbreviation"] = "Аббревиатура"
L["cluster"] = "Кластер"
L["rotate"] = "Поворот"
L["circle"] = "Круг"
...
L["Share Profile"] = "Поделиться профилем"