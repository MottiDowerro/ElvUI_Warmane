...
L["Say"] = "Say"
L["Scale"] = true
L["Scale Nameplates to UI Scale."] = true
...
L["Set the priority order of the spell, please note that priorities are only used for the raid debuff module, not the standard buff/debuff module. If you want to disable set to zero."] = true
...
L["TOTEM_AIR"] = "Air Totem"
L["TOTEM_EARTH"] = "Earth Totem"
L["TOTEM_FIRE"] = "Fire Totem"
L["TOTEM_WATER"] = "Water Totem"
L["Totems"] = "Totems"
L["Server Language Fix"] = true
L["Check this if your client language and server language are different. This will help with nameplate totem recognition."] = true
